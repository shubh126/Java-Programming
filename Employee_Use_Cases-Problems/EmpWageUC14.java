...
public class EmpWageUC14 implements ComputeEmpWageee {
	...
	public static void main(String[] args) {
		//creating object
		EmpWageUC14 empWageBuilder =new EmpWageUC14();
		empWageBuilder.addCompany("Euronet", 20, 20, 100);
		empWageBuilder.addCompany("TCS", 30, 27, 100);
		empWageBuilder.computeEmpWage();
		empWageBuilder.printList();
		
		System.out.println("Total wage for Euronet Company : "+empWageBuilder.getTotalWage("Euronet"));
